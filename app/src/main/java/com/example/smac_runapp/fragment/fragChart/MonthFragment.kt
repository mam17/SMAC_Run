...
class MonthFragment : Fragment() {
    ...
    private lateinit var monthPresenter: HomePresenter
    ...
    override fun onCreateView(
        ...
        monthPresenter = ViewModelProvider(this)[HomePresenter::class.java]
        observerComponent()
        mView = mBinding.root
        return mView
    }
    ...
    private fun observerComponent() {
        monthPresenter.dataChartByMonth.observe(viewLifecycleOwner) {
    ...
    private fun displayChart(
        ...
        MyCustomChart(context, mBinding.barChartMonth, lsBarEntries, lsAxis, 4000f).setUp()
    }
